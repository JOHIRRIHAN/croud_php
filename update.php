...
include 'connect.php';
$id= $_GET['updateid'];
$sql="select * from `croude` where id=$id";
...
if(isset($_POST['submit'])){
    ...
    $sql="update `croude` set id=$id,name='$name',email='$email',mobile='$mobile',password='$password' where id=$id";
    $result = mysqli_query($con,$sql);

    if($result){
        // echo "Data IUpdate Successful";
